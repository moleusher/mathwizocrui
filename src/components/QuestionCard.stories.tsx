...
const createFullQuestion = (overrides: Partial<ExamQuestion> = {}): ExamQuestion => ({
  question_index: 1,
  question_text:
    '计算圆柱体的体积，已知底面周长为 $12.56\\text{cm}$，高为 $10\\text{cm}$。',
  question_type: 'calculation',
  difficulty: 'medium',
  knowledge_points: ['圆柱体积', '圆周率应用'],
  images: [
    { url: 'http://localhost:6006/placeholder.jpg', caption: '圆柱示意图' },
  ],
  student_answer: {
...
const wrongQuestion = (): ExamQuestion => ({
  question_index: 3,
  question_text:
    '一个长方形的长是 $12\\text{cm}$，宽是 $8\\text{cm}$，求面积。',
  question_type: 'calculation',
  difficulty: 'easy',
